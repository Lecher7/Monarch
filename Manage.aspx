<%@ Page Title="Manage" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Manage.aspx.cs" Inherits="Account.Manage" %>
...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <div style="width: 950px; vertical-align: top; margin-left: 22px;">
        ...
        <ajaxToolkit:TabContainer ID="TabContainer1" runat="server" Height="500px" ScrollBars="Vertical">
        
         <ajaxToolkit:TabPanel runat="server" ID="Panel1" ScrollBars="Vertical" HeaderText="Primary Info">
                <ContentTemplate>

                    <fieldset>
                        <legend>Account Management Form</legend>
                            ...
                            <table>
                                <tr>
                                    ...
                                    <td style="width:300px">
                                        <asp:TextBox runat="server" ID="UserName" width="250" Enabled="false" />
                                    </td>
                                    <td style="width:180px">
                                        <asp:Label runat="server" AssociatedControlID="Email">Email address</asp:Label>
                                    </td>
                                    <td style="width:270px">
                                        <asp:TextBox runat="server" ID="Email" width="250" />
                                    </td>
                                </tr>
                                <tr>
                                    <td style="width:160px">
                                    ...
                                    <td style="width:300px">
                                        <asp:TextBox runat="server" ID="FName" width="250" Enabled="false" />
                                    </td>
                                    <td style="width:180px">
                                ...
                                <tr>
                                    ...
                                    <td style="width:270px">
                                        <div class="UCStyle3">
                                            <asp:ListBox ID="City" SelectionMode="Multiple" runat="server">
                                            </asp:ListBox>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td style="width:300px">
                                        <asp:TextBox runat="server" ID="Zipcode" width="250" OnTextChanged="LoadCities_Leave" AutoPostBack="true" />
                                    </td>
                                    <td style="width:180px">
                                        <asp:Label ID="Label3" runat="server" AssociatedControlID="DOB">Date Of Birth</asp:Label>
                                    </td>
                                    <td style="width:270px">
                                        <asp:TextBox id="DOB" runat="server" class="datepicker" style="height: 14px; width: 250px" Enabled="false" />
                                    </td>
                                </tr>
                                <tr>
                                    <td style="width:160px">
                                ...
                                <tr>
                                    ...
                                    <td style="width:300px">
                                        <div class="UCStyle2">
                                            <asp:ListBox ID="Zodiac" SelectionMode="Multiple" runat="server" Enabled="false">
                                            </asp:ListBox>
                                        </div>
                                    </td>
                                    <td style="width:180px">
                                ...
                                <tr>
                                    ...
                                    <td style="width:160px">
                                        <asp:Label ID="lblUserID" runat="server" AssociatedControlID="UserID" Visible="false">ID:</asp:Label>
                                    </td>
                                    <td style="width:300px">
                                        <div id="Div1">
                ...
                <ajaxToolkit:TabPanel runat="server" ID="Panel2" HeaderText="Write-Ups">
                <ContentTemplate>
                            <table>
                                <tr>
 ...
 <!--                           <table>
                                <tr>
                                    <td style="width:190px">
                                        <asp:Label runat="server" AssociatedControlID="Password">New Password (Leave blank to keep old password)</asp:Label>
                                    </td>
                                    <td style="width:300px">
                ...
                <ContentTemplate>
                    ...
                    <table>
                        <tr>
                            <td runat="server" id="igHide1"><img src="" id="igImage1" runat="server" alt="" height="100" width="100" /></td>
                            <td runat="server" id="igHide2"><img src="" id="igImage2" runat="server" alt="" height="100" width="100" /></td>
                            <td runat="server" id="igHide3"><img src="" id="igImage3" runat="server" alt="" height="100" width="100" /></td>    
                            <td runat="server" id="igHide4"><img src="" id="igImage4" runat="server" alt="" height="100" width="100" /></td>
                            <td runat="server" id="igHide5"><img id="igImage5" src="" runat="server" alt="" height="100" width="100" /></td>
                            <td runat="server" id="igHide6"><img id="igImage6" src="" runat="server" alt="" height="100" width="100" /></td>    
                        </tr>
            ...
            <table>
                <tr>
                    ...
                    <!--    <asp:Button ID="btnChgPass" runat="server" OnClick="btnChgPass_Click" Text="Change Password" />  -->
                    </td>                
                </tr>
            </table>
