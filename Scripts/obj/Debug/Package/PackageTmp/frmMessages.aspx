                                    ...
                                    <asp:Panel ID="Panel3" runat="server" BackColor="#ffffff" Height="76px" Style="margin-left: 1px;margin-bottom: 2px" Width="790px" Font-Size="Small" BorderColor="Black" BorderStyle="Solid" BorderWidth="1px">            
                                        <table style="width:760px">
                                            <tr style="color:White; background-color:#007ACC">
                                                <td rowspan="3" style="width:65px"><asp:HyperLink runat="server" ID="hlThumbnail" NavigateUrl='<%# "../UserTemplate.aspx?U=" + Eval("OtherUserID") %>'><asp:Image ID="LinkEdit" runat="server" Height="65px" CommandArgument='<%#Eval("MUserImg1") %>'></asp:Image></asp:HyperLink></td>  
                                            </tr>
                                            <tr style="height:7px">
                                                <td style="width:100px"> 
