                                ...
                                <asp:Panel ID="Panel3" runat="server" BackColor="#ffffff" Height="126px" Style="margin-left: 1px;margin-bottom: 2px" Width="800px" Font-Size="Small" BorderColor="Black" BorderStyle="Solid" BorderWidth="1px">            
                                    <table style="width:790px">
                                        <tr style="color:White; background-color:#007ACC">
                                            <td rowspan="5" style="width:115px"><asp:HyperLink runat="server" ID="hlThumbnail" NavigateUrl='<%# "../UserTemplate.aspx?U=" + Eval("UserID") %>'><asp:Image ID="LinkEdit" runat="server" Height="115px" CommandArgument='<%#Eval("UserImg1") %>'></asp:Image></asp:HyperLink></td>  
                                        </tr>
                                        <tr style="height:7px">
                                            <td style="width:120px"> 
                                                <asp:Label ID="lblAcctNum" runat="server" width="120px" Text='<%#Eval("UserName") %>'></asp:Label>
                                            </td>
                                            <td colspan="2">
                                                <asp:Label ID="lblDOS" runat="server" Text='<%#Eval("UserTitle") %>'></asp:Label>
                                            </td>
                                        </tr>
                                        <tr style="height:7px">
                                            <td colspan="3">
                                                <asp:Label ID="lblLocation" runat="server" Text='<%# "Age: " + Eval("UserAge") + "  |  " + Eval("UserCity") + ", " + Eval("UserState") + "  |  " + Eval("LastLoginDate", "{0:d}")  %>'></asp:Label>
                                            </td>
                                        </tr>
                                        <tr style="height:7px">
                                            <td colspan="3">
                                                 <asp:Label ID="Label2" runat="server" Text='<%#Eval("UserBody") %>'></asp:Label>
                                            </td>
                                        </tr>
                                        <tr style="height:7px">
                                            <td colspan = "2">
                                                <asp:Label ID="lblIntent" runat="server" Text='<%#Eval("UIntent") %>'></asp:Label>
                                            </td>
                                            <td>
                                                <asp:Label ID="lblInCommon" runat="server" Text='<%#Eval("NumInterests") + " Mutual Interests" %>'></asp:Label> 
                                            </td>
                                        </tr>   
                                    </table>
                                    </asp:Panel>
