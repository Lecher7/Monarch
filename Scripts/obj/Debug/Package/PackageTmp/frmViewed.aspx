<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmViewed.aspx.cs" Inherits="OLDSite.frmViewed" %>
    ...
    <div id="UserPlate" style="width:800px; background-color:whitesmoke; margin-left:20px">
        <div class="clear hideSkiplink" id="TopMenu" style="width:800px">
            <asp:Menu ID="ContactMenu" runat="server" CssClass="menu" 
                ...
                <Items> 
                    <asp:MenuItem Text="Viewed Me"/>
                    <asp:MenuItem Text="Viewed"/>
                </Items>
            </asp:Menu>
        </div>
        <table>
                                     ...
                                     <table>
                                            <tr style="height:7px">
                                                ...
                                                <td style="width:160px">
                                                    <asp:Label ID="lblFlaggedH" runat="server" Text="Date Last Viewed"></asp:Label>
                                                </td>
                                                <td>
                                    ...
                                    <asp:Panel ID="Panel3" runat="server" BackColor="#ffffff" Height="76px" Style="margin-left: 1px;margin-bottom: 2px" Width="790px" Font-Size="Small" BorderColor="Black" BorderStyle="Solid" BorderWidth="1px">            
                                        <table style="width:760px">
                                            <tr style="color:White; background-color:#007ACC">
                                                <td rowspan="3" style="width:65px"><asp:HyperLink runat="server" ID="hlThumbnail" NavigateUrl='<%# "../UserTemplate.aspx?U=" + Eval("ViewerUserID") %>'><asp:Image ID="LinkEdit" runat="server" Height="65px" CommandArgument='<%#Eval("UserImg1") %>'></asp:Image></asp:HyperLink></td>  
                                            </tr>
                                            <tr style="height:7px">
                                                <td style="width:100px"> 
                                                    <asp:Label ID="lblAcctNum" runat="server" width="120px" Text='<%#Eval("ViewerName") %>'></asp:Label>
                                                </td>
                                                <td style="width:170px">
                                                    <asp:Label ID="lblDOS" runat="server" Text='<%#Eval("DateLastViewed") %>'></asp:Label>
                                                </td>
                                                <td>
