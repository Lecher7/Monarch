                                    ...
                                    <asp:Panel ID="Panel3" runat="server" BackColor="#ffffff" Style="margin-left: 1px;margin-bottom: 2px" Width="790px" Font-Size="Small" BorderColor="Black" BorderStyle="Solid" BorderWidth="1px">            
                                        <table style="width:760px">
                                            <tr style="color:White; background-color:#007ACC">
                                                <td rowspan="3" style="width:65px; vertical-align:top"><asp:HyperLink runat="server" ID="hlThumbnail" NavigateUrl='<%# "../UserTemplate.aspx?U=" + Eval("UserID") %>'><asp:Image ID="LinkEdit" runat="server" Height="65px" CommandArgument='<%#Eval("MgrImg1") %>'></asp:Image></asp:HyperLink></td>  
                                            </tr>
                                            <tr style="height:7px">
