...
namespace OLDSite
{
    public partial class frmFavorites : System.Web.UI.Page
    {
        ...
        {
            if (((Menu)sender).SelectedItem.Text == "My Favorites")
            {
                lblMailbox.Text = "My Favorites";
                LinkVisible = true;
            ...
            if (((Menu)sender).SelectedItem.Text == "Favorited Me")
            {
                lblMailbox.Text = "Favorited Me";
                LinkVisible = false;
                ...
                SqlCommand cmd2 = new SqlCommand();
                cmd2.CommandType = CommandType.StoredProcedure;
                cmd2.CommandText = "sp_FavedByOthers";
                cmd2.Connection = connection2;
